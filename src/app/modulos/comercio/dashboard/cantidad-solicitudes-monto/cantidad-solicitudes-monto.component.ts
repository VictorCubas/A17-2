...
@Component({
    selector: 'app-cantidad-solicitudes-monto',
    templateUrl: './cantidad-solicitudes-monto.component.html',
    styleUrls: ['./cantidad-solicitudes-monto.component.scss'],
})
export class CantidadSolicitudesMontoComponent implements OnInit, OnDestroy {
    colorScheme: any = {
        domain: [
            '#723E98',
            '#F9AC3D',
