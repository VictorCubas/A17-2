...
@Component({
    selector: 'app-chart-volumen',
    templateUrl: './chart-volumen.component.html',
    styleUrls: ['./chart-volumen.component.scss'],
})
export class ChartVolumenComponent implements OnInit, OnDestroy {
    colorScheme: any = {
        domain: [
            '#723E98',
            '#F9AC3D',
