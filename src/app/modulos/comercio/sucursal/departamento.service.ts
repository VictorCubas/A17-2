...
import { Departamento } from 'app/clases/departamento';
...
export class DepartamentoService extends MetodosServicio<Departamento> {
    constructor(
        public override http: HttpClient,
        private settings: SettingsService
    ) {
        super(http, settings.URL_BASE + 'public/departamento', Departamento);
        console.log(this.settings.URL_BASE);
    }

    restartItem(): void {
        this.setItem(new Departamento());
    }
