...
const customPalettes = {
    ...
    customPrimary: generatePalette('#031834'),
    customAccent: generatePalette('#008080'),
    customWarn: generatePalette('#0098C1'),
};
...
const themes = {
    ...
    'default': {
        ...
        warn     : customPalettes.customWarn,
        'on-warn': customPalettes.customWarn
    },
